                            ...
                            <div class="imageSlide js-banner owl-carousel">
                                <div>
                                    <a href="javascript:;" title="slide">
                                        <img alt="Đồ án tốt nghiệp" src="<?php echo e(pare_url_file('2024-04-21__banner-tgnh-thang3.jpg')); ?>"  style="max-width: 100%;height: 300px;" class="" />
                                    </a>
                                </div>
                                <div>
                                    <a href="javascript:;" title="slide">
                                ...
                                <div>
                                    <a href="javascript:;" title="slide">
                                        <img alt="Đồ án tốt nghiệp" src="<?php echo e(pare_url_file('2024-04-21__banner-web-bgxshopee.png')); ?>"  style="max-width: 100%;height: 300px;" class="" />
                                    </a>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app_master_frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\laravel8-banquanao\resources\views/frontend/pages/home/index.blade.php ENDPATH**/ ?>