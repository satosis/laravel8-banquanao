        ...
        <div class="card">
            <div class="card-body info-detail">
                <div class="left">
                        ...
                        <a href="javascript:;">
                        <img alt="" style="max-width: 100%;width: 100%;height: 450px" src="<?php echo e(pare_url_file($product->pro_avatar)); ?>"
...
<?php echo $__env->make('layouts.app_master_frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\laravel8-banquanao\resources\views/frontend/pages/product_detail/index.blade.php ENDPATH**/ ?>