...
<html lang="en">
    <head>
        ...
        <link href="<?php echo e(asset('user/theme.css')); ?>" rel="stylesheet" type="text/css" media="all" />
    </head>
    <body>
        <div class="layout layout-nav-side">
            <div class="navbar navbar-expand-lg bg-dark navbar-dark sticky-top">
                <a class="navbar-brand" href="/">
                    <img alt="Pipeline" src="<?php echo e(url('images/logo.png')); ?>" style="max-width: 100%" />
                </a>
                ...
                <div class="collapse navbar-collapse flex-column" id="navbar-collapse">
                    <ul class="navbar-nav d-lg-block">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('get.user.update_info')); ?>">Cập nhật thông tin</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('get.user.transaction')); ?>">Quản lý đơn hàng</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('get.user.favourite')); ?>">Sản phẩm yêu thích</a>
                        </li>
        ...
        <script type="text/javascript" src="<?php echo e(asset('user/js/jquery.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('user/js/popper.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('user/js/bootstrap.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('user/js/autosize.min.js')); ?>"></script>
        <!-- Flatpickr (calendar/date/time picker UI) -->
        <script type="text/javascript" src="<?php echo e(asset('user/js/flatpickr.min.js')); ?>"></script>

        <script type="text/javascript" src="<?php echo e(asset('user/js/draggable.bundle.legacy.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('user/js/swap-animation.js')); ?>"></script>
        <!-- Dropzone - drag and drop files onto the page for uploading -->

        <!-- List.js - filter list elements -->
        <script type="text/javascript" src="<?php echo e(asset('user/js/list.min.js')); ?>"></script>
        <!-- Required theme scripts (Do not remove) -->
        <script type="text/javascript" src="<?php echo e(asset('user/js/theme.js')); ?>"></script>
...
<?php /**PATH D:\project\laravel8-banquanao\resources\views/layouts/app_master_user_v1.blade.php ENDPATH**/ ?>