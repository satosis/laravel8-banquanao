                        ...
                        <?php $__currentLoopData = $ratings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $rating): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td style="width: 30%;text-align: left">
                                    <a href="<?php echo e(route('get.product.detail',$rating->product->pro_slug . '-'.$rating->product->id )); ?>" style="color:blue;text-decoration:underline">
                                        <?php echo e($rating->product->pro_name ?? "[N\A]"); ?>
...
<?php echo $__env->make('layouts.app_master_user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\laravel8-banquanao\resources\views/user/rating.blade.php ENDPATH**/ ?>